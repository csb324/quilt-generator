...
module.exports = {
  ...
  blend_color: function(color1, color2, percent) {
    // https://stackoverflow.com/questions/5560248/programmatically-lighten-or-darken-a-hex-color-or-rgb-and-blend-colors
    var color1ToInt = parseInt(color1.slice(1),16);
    var color2ToInt = parseInt(color2.slice(1), 16);
    
    var red1=color1ToInt>>16,
        green1=color1ToInt>>8&0x00FF,
        blue1=color1ToInt&0x0000FF;
    
    var red2=color2ToInt>>16,
        green2=color2ToInt>>8&0x00FF,
        blue2=color2ToInt&0x0000FF;
    
    var absPercent = Math.abs(percent);
    
    var hex = (
      0x1000000 +
      (Math.round((red2-red1)*absPercent)+red1) * 0x10000 +
      (Math.round((green2-green1)*absPercent)+green1) * 0x100 + 
      (Math.round((blue2-blue1)*absPercent)+blue1)
    );
